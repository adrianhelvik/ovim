...
const prettierOptions = await resolveConfig(outputPath, { editorconfig: true });
const source = await format(
    `// Generated from gui-design-guide/icons/dist/manifest.json.
...
console.log(`Generated ${names.length} icon names in ${outputPath}`);
